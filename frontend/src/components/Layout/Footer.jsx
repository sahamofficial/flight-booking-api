    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">Jet-Air</span>
            </div>
            <p className="mt-4 text-sm text-gray-300">
              Your trusted travel partner since 2010. Making travel dreams come true with exceptional service and competitive prices.
            </p>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">&copy; {new Date().getFullYear()} Jet-Air Travel Agency. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
